...
Photino::Photino(PhotinoInitParams *initParams) : _webview(nullptr)
{
	...
	if (initParams->Size != PHOTINO_INIT_PARAMS_SIZE)
	{
		GtkWidget *dialog = gtk_message_dialog_new(
			nullptr, GTK_DIALOG_DESTROY_WITH_PARENT, GTK_MESSAGE_ERROR, GTK_BUTTONS_CLOSE, "Initial parameters passed are %i bytes, but expected %i bytes.", initParams->Size, PHOTINO_INIT_PARAMS_SIZE);
